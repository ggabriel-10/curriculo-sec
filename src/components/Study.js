        ...
        <div className='area-study' id='study'>
            ...
            <div className='study-course'>
                ...
                <div>
                    ...
                    <p>Verification code: <strong>48b090f4-a3d3-4777-8523-ecd65e689cf5</strong></p>
                </div>
                <ButtonStudy link='https://app.rocketseat.com.br/discover/certificates' alt='Certificado' label='Certificate'/>
            </div>
            ...
            <div className='study-course'>
                ...
                <div>
                    ...
                    <p>Verification code: <strong>DtDYZO6ZtY</strong></p>
                </div>
            ...
            <div className='study-course'>
                ...
                <ButtonStudy link='https://www.linkedin.com/feed/update/urn:li:activity:7063496140024877057/' alt='Certificado' label='Certificate'/>
            </div>
